...
while (1):
    ...
    if TrackingState == TRACKING_STATE_CHECK:
        ...
        if ref:
            ...
            cv2.putText(frame, 'Dected Face', (int(TrackingROI[0])-5,int(TrackingROI[1])-5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,0,255), 2)
            ...
            ##roi = frame[int(TrackingROI[1]):int(TrackingROI[1]) + int(TrackingROI[2]), int(TrackingROI[0]):int(TrackingROI[0]) + int(TrackingROI[3])]
    ...
    cv2.putText(frame, str, (0, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))
    cv2.putText(frame, str_n, (0, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))
    cv2.putText(frame, str_a, (0, 75), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))
    cv2.putText(frame, str_f, (0, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))
    cv2.putText(frame, str_c, (0, 125), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))
    cv2.putText(frame, str_d, (0, 150), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))
    cv2.putText(frame, str_h, (0, 175), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))
    cv2.putText(frame, str_s, (0, 200), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))
    cv2.putText(frame, str_ss, (0, 225), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0))
